...
model_0=LSTMModel(hidden_size=128, num_layers=2, num_classes=len(emotions)).to(device)

#Define loss function and optimizer
optimizer = optim.Adam(model_0.parameters(), lr=0.001,weight_decay=1e-5)
...
# Create DataLoaders
train_dataloader_raf = DataLoader(train_dataset_raf, batch_size=64, shuffle=True)
val_dataloader_raf = DataLoader(val_dataset_raf, batch_size=64, shuffle=False)
test_dataloader_raf = DataLoader(test_dataset_raf, batch_size=64, shuffle=False)
